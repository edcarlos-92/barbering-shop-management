...
export default function GoHomeBar() {
  return (

    <footer className="" aria-labelledby="footer-heading">{/* bg-gray-900 */}
      <h2 id="footer-heading" className="sr-only"> GoHomeBar </h2>
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-3 lg:px-8">

        <div className="mt-0 border-t border-gray-700 pt-0 md:flex md:items-center md:justify-between">
          ...
          {/* <p className="mt-8 text-base  md:mt-0 md:order-1">
                &copy; 2024 Barber Shop Management System. All Rights Reserved
              </p>
            
              <a  href="#"   className="mt-8 text-base  md:mt-0 md:order-1" >
                Privacy & Policy
            </a> */}
