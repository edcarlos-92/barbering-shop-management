...
export default function SelectInputAlgo(props) {
    ...
    <>
      ...
      <Grid sx={{ width: 250, mr: 2, mt: 4 }}>
        <Controls.BasicSelect
          //sx={{ width: 250, mr: 2, mt: -5 }}
          variant={variant}
          margin={margin}
          //id={`select_${fieldIndex}`}
          //name={`select_${fieldIndex}`}
          id="algo_components"
          name="algo_components"
          label={`${criteriaLabel} (${requiredUnit})`}
          value={fieldValue}
          options={constrainOptions ? constrainOptions : [{}]}
          displayField={`id`}
          defaultValue={`Choose...`}
