...
import { removeSquareBracketWithString, getSquareBracketString, objectValueWithReference, niceDateDefault } from '@edcarlos/libs/@edcartech/utils';
...
export default function DateInputAlgo(props) {
  ...
  const handleInputChange = (e) => {
    ...
    if (e.target.value) {//
      ...
      const matcherObject = {
        ...
        algo_type: 'personal',
        applicant_provision: niceDateDefault(e.target.value, 'y')
      }
  ...
  return (
    <>
      ...
      <Grid sx={{ width: 250, mr: 2, mt: 4 }}>
        <DefaultDatePicker
          //sx={{ width: 250, mr: 2, mt: 0 }}
          //fullWidth
          margin={margin}
          variant={variant}
          id="algo_components"
          name="algo_components"
          //defaultValue={aplicant_dob.value}
          label={`${criteriaLabel} (${requiredUnit})`}
          value={fieldValue}
          onChange={handleInputChange}
        //required={aplicant_dob.required}
        //error={!!aplicant_dob.error}
        />
      </Grid>
