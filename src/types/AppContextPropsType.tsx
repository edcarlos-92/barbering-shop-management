...
import { LanguageProps } from "../@edcarlos/core/AppLngSwitcher/data";
...
interface EdcarlosPalette extends Palette {
  background: {
    paper: string;
    default: string;
  };
...
export interface EdcarlosTheme extends Theme {
  direction: Direction;
  cardRadius: number;
  palette: EdcarlosPalette;
  status: {
    danger: string;
  };
  divider: string;
