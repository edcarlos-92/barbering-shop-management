...
import { useAuthMethod } from "../../../@edcarlos/utility/AuthHooks";
...
const SigninFirebase = () => {
  ...
  const signInWithEmailAndPassword = (data) => { }//Fake
  const signInWithPopup = (data) => { }//Fake
