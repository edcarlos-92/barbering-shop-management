...
export default function ExpensesDetailPage(props: any) {
  ...
  const { companyContactInfo } = companyInformation
            ...
            >
              ...
              <div id="receipt-POS">
                ...
                <span id="top">
                  ...
                  <div className="info">
                    <h2 className="center-content make-bold">BARBERSHOP-RECEIPT</h2>
