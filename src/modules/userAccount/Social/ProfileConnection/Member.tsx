...
import { AppCard } from "@edcarlos";
import { alpha, Avatar, Box, Typography } from "@mui/material";
import Button from "@mui/material/Button";
import { Fonts } from "../../../../shared/constants/AppEnums";
import { MemberData } from "@edcarlos/services/db/extraPages/account";
  ...
  return (
    <AppCard
      ...
      sxStyle={{
        boxShadow: "none",
        borderRadius: 1,
        border: (theme: EdcarlosTheme) => `solid 1px ${theme.palette.divider}`,
        height: "100%",
      }}
      titleStyle={{
        fontSize: 12,
        fontWeight: Fonts.SEMI_BOLD,
        color: (theme: EdcarlosTheme) => theme.palette.text.secondary,
      }}
    >
      {connect ? (
        <Box sx={{ mb: 2 }}>
